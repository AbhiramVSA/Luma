...
import { buildApiUrl, getAuthToken, setAuthToken } from "@/lib/api"
...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error(error)
      setStatusMessage("Unable to sign in. Check your credentials and try again.")
    } finally {
      setIsLoading(false)
    }
  }
      ...
      >
        ...
        >
          ...
          <div className="mt-6 text-center text-sm text-zinc-400">
            Accounts are provisioned internally. Contact an administrator if you need access.
          </div>
        </motion.div>
      </motion.div>
    </div>
